...
<h1 class="title">Drawing in Javascript</h1>

> **Contents**<br/>
> [Web Drawing Inspiration](#web-drawing-inspiration)<br/>
> [Example Files](#example-files)<br/>
> [Underlying Technology](#underlying-technology)<br/>
> [Working With a Library](#working-with-a-library)<br/>
> [Diving into Paper.js](#diving-into-paper-js)<br/>
...
> <a href="basics.html" target="_blank">Example: Basics in Underlying APIs</a><br/>
> ![codesample](../images/links/tag_codesample.png)<br/>
...
> <a href="paper_basics.html" target="_blank">Example: Basics in Paper</a><br/>
> ![codesample](../images/links/tag_codesample.png)<br/>
...
> <a href="paper_structure.html" target="_blank">Example: What Makes a Path</a><br/>
> ![codesample](../images/links/tag_codesample.png)<br/>
...
> <a href="paper_file_io.html" target="_blank">Example: Paper Tiger</a><br/>
> ![codesample](../images/links/tag_codesample.png)<br/>
...
> <a href="paper_circle_looping.html" target="_blank">Example: Drawing Circles with the mouse</a><br/>
> ![codesample](../images/links/tag_codesample.png)<br/>
> In this example, users can draw circles with the mouse and control animation playback with the keyboard.

> <a href="paper_path_following.html" target="_blank">Example: Animating along a path</a><br/>
> ![codesample](../images/links/tag_codesample.png)<br/>
